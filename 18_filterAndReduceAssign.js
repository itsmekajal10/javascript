...
console.log(`----------All the employees from Wipro--------------`);
...
console.log(`----------All the employees whose name start with 'A' or 'V' or 'M'-----------`);
...
arrayEmps.forEach((employee) => {
  ...
  console.log(`------------All departments average salary of employee----------`);
